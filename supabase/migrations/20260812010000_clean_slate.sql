-- ============================================================================
-- GROWZY V1 - CLEAN SLATE MIGRATION (ZERO MOCK SEED DATA)
-- Agency Operating System: Fresh DB Reset for User Onboarding
-- ============================================================================

-- 1. WIPE ALL EXISTING AUTH USERS AND SEED DATA
DO $$ BEGIN
    DELETE FROM auth.users;
EXCEPTION WHEN OTHERS THEN null; END $$;

-- 2. DROP PUBLIC TABLES IN REVERSE DEPENDENCY ORDER FOR CLEAN RE-INITIALIZATION
...
-- NO SEED DATA ATTACHED. ZERO MOCK ROWS.
